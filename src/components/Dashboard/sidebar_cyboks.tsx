  ...
  return (
    <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
          <ul className="space-y-2 font-medium">
             <li>
                <Link href="/dashboard_cyboks" className="flex items-center p-2 text-white rounded-lg hover:bg-orange-500 group hover:font-bold">
             ...
             <li> 
               <div className='text-white rounded-lg hover:bg'>
                  <div className={(router === '/dashboard_cyboks/received' || router === '/dashboard_cyboks/under_review')?"flex items-center p-2 text-gray-600 rounded-lg bg-white group font-bold":"flex items-center p-2 text-gray-900 rounded-lg hover:bg-orange-500 group hover:font-bold"} onClick={toggleDropdown}>
                  <div className=" bg-white px-2 py-1 rounded-lg group-hover:bg-orange-500 ">
                   ...
                   <svg  className="flex-shrink-0 w-5 h-5 text-orange-500 transition duration-75 group-hover:text-white " width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <rect x="3" y="12" width="6" height="8" rx="1" />  <rect x="9" y="8" width="6" height="12" rx="1" />  <rect x="15" y="4" width="6" height="16" rx="1" />  <line x1="4" y1="20" x2="18" y2="20" /></svg>
                     ...
                     <li>
                     <Link href="/dashboard_cyboks/received" className={(router === '/dashboard_cyboks/received')?"flex items-center p-2 text-white rounded-lg bg-orange-500 group font-bold":"flex items-center p-2 text-white rounded-lg hover:bg-orange-500 group hover:font-bold"}>
                     ...
                     <li>
                     <Link href="/dashboard_cyboks/under_review" className={(router === '/dashboard_cyboks/under_review')?"flex items-center p-2 text-white rounded-lg bg-orange-500 group font-bold":"flex items-center p-2 text-white rounded-lg hover:bg-orange-500 group hover:font-bold"}>
                     <div className=" ml-16 p-2">
                     ...
                     <li>
                     <Link href="/dashboard_cyboks/cancelled" className={(router === '/dashboard_cyboks/cancelled')?"flex items-center p-2 text-white rounded-lg bg-orange-500 group font-bold":"flex items-center p-2 text-white rounded-lg hover:bg-orange-500 group hover:font-bold"}>
                     <div className=" ml-16 p-2">
                     ...
                     <li>
                     <Link href="/dashboard_cyboks/sent" className={(router === '/dashboard_cyboks/sent')?"flex items-center p-2 text-white rounded-lg bg-orange-500 group font-bold":"flex items-center p-2 text-white rounded-lg hover:bg-orange-500 group hover:font-bold"}>
                     <div className=" ml-16 p-2">
                     ...
                     <li>
                     <Link href="/dashboard_cyboks/certified" className={(router === '/dashboard_cyboks/certified')?"flex items-center p-2 text-white rounded-lg bg-orange-500 group font-bold":"flex items-center p-2 text-white rounded-lg hover:bg-orange-500 group hover:font-bold"}>
                     <div className=" ml-16 p-2">
             ...
             <li>
                <Link href="/dashboard_cyboks/feedback" className="flex items-center p-2 text-white rounded-lg hover:bg-orange-500 group hover:font-bold">
                   <div className=" bg-white px-2 py-1 rounded-lg group-hover:bg-orange-500 ">
