    ...
    return(
        ...
        <div className="p-4 sm:ml-64">
            <div className="pt-12 p-2 mt-14 rounded-lg sm:rounded-lg m-2">
                <div>
                    <h3 className="font-bold font-['Open Sans'] text-lg text-white pl-2 pt-1">CHUK</h3>
                </div>
                <div className='mt-6'>
                    <ol className="flex items-center w-full text-sm font-medium text-center text-white dark:text-white sm:text-base">
                        <li className="flex md:w-full items-center text-violet-500 dark:text-violet-400 sm:after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10 dark:after:border-gray-700">
                    ...
                    <div className="text-white text-lg mt-4 hover:text-violet-500">
