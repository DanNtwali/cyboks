  ...
  return (
    <main className="flex sm:flex-row bg-slate-300 bg-white flex-col-reverse">
      <div className="lg:w-1/2 w-full pt-56 px-16 h-screen items-center ">
        <>
            <p className=" text-lg font-['Open Sans']"><span className="font-bold">Important</span>  Information Please <span className="font-bold">read</span> the information below and then kindly share the requested information. </p>
      ...
      <form onSubmit={handleSubmit}
        ...
        <div className="flex flex-row justify-end px-24">
          <div className="text-right mr-4">
            ...
            <h4 className="text-white font-semibold">Back to <Link href='/' className="font-bold text-orange-500 hover:underline">Login</Link></h4>
          </div>
          <button 
           type='submit'
           className="bg-white hover:bg-green-50 text-orange-500 font-semibold py-2 w-1/4 rounded-lg border">
            Next
          </button>
        </div>
      </form>
