          ...
          <ol className="ml-20 mt-6 relative text-white border-l border-violet-500 dark:border-gray-700 dark:text-gray-400">
            ...
            <li className="mb-10 ml-6">
              <span className="absolute flex items-center justify-center w-8 h-8 bg-violet-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-violet-300">
                <svg className="w-3.5 h-3.5 text-violet-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">
            ...
            <li className="mb-10 ml-6">
              <span className="absolute flex items-center justify-center w-8 h-8 bg-violet-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-violet-300">
                <svg className="w-3.5 h-3.5 text-violet-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
            ...
            <li className="ml-6">
              ...
              <p className="text-xs font-light">click <Link href="" className="text-center hover:text-violet-600 hover:font-extrabold font-['Open Sans'] leading-tight">here</Link> to download your certificate</p>
            </li>
          </ol>
       </div>
       </main>
