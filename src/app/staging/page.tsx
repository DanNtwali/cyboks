        ...
        <div className="sm:flex sm:flex-row mt-16">
          <div className="flex flex-row bg-white rounded-lg p-4 mx-6 w-full justify-between mt-2">
            <div className="flex flex-row justify-between">
              <p className="text-slate-400 text-xs font-bold font-['Open Sans'] leading-[18px] mr-4">
                Uploaded <br />
                Documents
              </p>
            </div>
            <div className="">
              <p className="text-gray-700 text-lg font-bold font-['Open Sans'] leading-relaxed">
                7
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row bg-white rounded-lg p-4 mx-6 w-full justify-between mt-2">
            <div className="flex flex-row justify-between">
              <p className="text-slate-400 text-xs font-bold font-['Open Sans'] leading-[18px]">
                Notification
              </p>
            </div>
            <div className="">
          ...
          <ol className="ml-20 mt-6 relative text-white border-l border-violet-400 dark:border-gray-700 dark:text-gray-400">
            <li className="mb-10 ml-6">
              <span className="absolute flex items-center justify-center w-8 h-8 bg-violet-300 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-violet-400">
              ...
              <p className="text-xs font-light">client's documents were received by CYBOKS</p>
            </li>
            <li className="mb-10 ml-6">
              <span className="absolute flex items-center justify-center w-8 h-8 bg-violet-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-violet-300">
                <svg className="w-3.5 h-3.5 text-violet-400 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">
              ...
              <p className="text-xs font-light">client's documents are being reviewed by CYBOKS</p>
            </li>
            <li className="mb-10 ml-6">
              <span className="absolute flex items-center justify-center w-8 h-8 bg-violet-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-violet-300">
                <svg className="w-3.5 h-3.5 text-violet-400 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
              ...
              <p className="text-xs font-light">client's documents were sent to NCSA for review</p>
            </li>
            <li className="mb-10 ml-6">
              <span className="absolute flex items-center justify-center w-8 h-8 bg-violet-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-violet-300">
                <svg className="w-3.5 h-3.5 text-violet-400 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
              ...
              <h3 className="font-medium leading-tight">Under Review</h3>
              <p className="text-xs font-light">client's documents are being reviewed by NCSA</p>
            </li>
            <li className="ml-6">
              <span className="absolute flex items-center justify-center w-8 h-8 bg-violet-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-violet-300">
                <svg className="w-3.5 h-3.5 text-violet-400 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
              ...
              <p className="text-xs font-light">client's certificate ready to be downloaded</p>
            </li>
          </ol>
       </div>
       </main>
