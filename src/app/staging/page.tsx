...
function Status() {
    return(
        ...
        <div className="sm:flex sm:flex-row mt-16">
          ...
          <ol className="ml-20 mt-6 relative text-white border-l border-orange-500 dark:border-gray-700 dark:text-gray-400">
            <li className="mb-10 ml-6">
              <span className="absolute flex items-center justify-center w-8 h-8 bg-orange-300 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-orange-500">
              ...
              <p className="text-xs font-light">client's documents were received by AQS</p>
            </li>
            <li className="mb-10 ml-6">
              <span className="absolute flex items-center justify-center w-8 h-8 bg-orange-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-orange-300">
                <svg className="w-3.5 h-3.5 text-orange-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">
              ...
              <p className="text-xs font-light">client's documents are being reviewed by AQS</p>
            </li>
            <li className="mb-10 ml-6">
              <span className="absolute flex items-center justify-center w-8 h-8 bg-orange-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-orange-300">
                <svg className="w-3.5 h-3.5 text-orange-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
